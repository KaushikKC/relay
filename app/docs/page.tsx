          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
            <div className="glass-card p-8">
              ...
              <p className="text-white/80 text-lg leading-relaxed mb-6">
                Relay uses the LI.FI SDK to provide seamless cross-chain bridging. 
                The SDK handles route discovery, execution, and monitoring automatically.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Automatically finds the best route across chains with optimal fees and speed.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Execute bridges with a single transaction. No manual steps required.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Track bridge progress with live status updates and transaction hashes.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="glass-card p-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    <pre className="glass-card p-4 rounded-lg overflow-x-auto">
                      <code className="text-sm text-white/90">{codeExamples.install}</code>
                    </pre>
                    <button
                ...
                <div>
                  ...
                  <div className="relative">
                    <pre className="glass-card p-4 rounded-lg overflow-x-auto">
                      <code className="text-sm text-white/90">{codeExamples.basic}</code>
                    </pre>
                    <button
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">3. Execute Routes</h3>
                  <div className="relative">
                    <pre className="glass-card p-4 rounded-lg overflow-x-auto">
                      <code className="text-sm text-white/90">{codeExamples.execute}</code>
                    </pre>
                    <button
                      onClick={() => copyToClipboard(codeExamples.execute, 'execute')}
                      className="absolute top-4 right-4 px-3 py-1 rounded bg-white/5 border border-white/10 text-white/70 hover:bg-white/10 transition-colors text-sm"
                    >
